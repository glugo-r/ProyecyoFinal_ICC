...
public class ItemOrden {
    ...
    public int getCantidadLista() { return cantidadLista; }
    public int getCantidadPendiente() { return cantidad - cantidadLista; }
    public double getSubtotal() { return platillo.getPrecio() * cantidad; }
